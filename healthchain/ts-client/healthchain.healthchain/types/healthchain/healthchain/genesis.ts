...
function createBaseGenesisState(): GenesisState {
  return { params: undefined, recordList: [], recordCount: 0 };
}
...
export const GenesisState = {
  encode(message: GenesisState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.recordCount !== 0) {
      writer.uint32(24).uint64(message.recordCount);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.recordCount = longToNumber(reader.uint64() as Long);
          break;
        default:
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      recordList: Array.isArray(object?.recordList) ? object.recordList.map((e: any) => Record.fromJSON(e)) : [],
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(object: I): GenesisState {
    ...
    message.params = (object.params !== undefined && object.params !== null)
      ...
      : undefined;
    message.recordList = object.recordList?.map((e) => Record.fromPartial(e)) || [];
